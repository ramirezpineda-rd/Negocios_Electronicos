...
if( ! defined( 'DIGITAL_DOWNLOAD_THEME_VERSION' ) ) define ( 'DIGITAL_DOWNLOAD_THEME_VERSION', $theme_data->get( 'Version' ) );
if( ! defined( 'DIGITAL_DOWNLOAD_THEME_NAME' ) ) define( 'DIGITAL_DOWNLOAD_THEME_NAME', $theme_data->get( 'Name' ) );
