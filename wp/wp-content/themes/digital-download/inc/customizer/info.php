...
if ( ! function_exists( 'digital_download_customizer_theme_info' ) ) :
	...
	function digital_download_customizer_theme_info( $wp_customize ) {
		...
		$theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Demo Link : ', 'digital-download' ), esc_url( __( 'https://demo.rarathemes.com/digital-download/', 'digital-download' ) ), esc_html__( 'Click here.', 'digital-download' ) );
